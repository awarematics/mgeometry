...
<body onload="trajectory();">
	...
	<div id="rightlayer" style="position: absolute; left:1500px; top:300px;">
		<ul id="mouse-menu">
			<li>Position: [40.7780543994538291,
			-73.9516338520440684]</li>
			<li>Time: 2017/9/2 21:14:22</li>
			<li>Direction2d: 82.776</li>
		</ul>
