...
public class BddDataToPostgreSQLMDouble {
	...
	public static void main(String args[]) throws IOException {
		...
		{
			writerContent = writerContent+ " UPDATE usersensors \r\n SET md_gyroz  = append(md_gyroz , '"+result[i] + "')\r\n"+ " WHERE id = "+ (i+1)+";\r\n\n\n";
		}
        File file = new File("D:\\mdouble_gyroz.txt");
        if (!file.exists()) {
            file.createNewFile();
        }
	...
	/*
	 * type:  mdouble_accx mdouble_accy mdouble_accz mdouble_gyrox
	 * mdouble_gyroy mdouble_gyroz
	 */
	// @Function
